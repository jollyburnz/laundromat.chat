  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      <div>
        ...
        <div className="relative">
          <input
            ...
            className={`w-full px-4 py-2 pr-10 border-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-laundry-blue focus:border-laundry-blue text-black ${getInputBorderColor()}`}
      ...
      <button
        ...
        className="w-full bg-laundry-blue text-white py-2 rounded-lg hover:bg-laundry-blue-dark disabled:opacity-50 disabled:cursor-not-allowed font-medium"
      >
