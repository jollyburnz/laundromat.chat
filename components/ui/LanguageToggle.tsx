...
export default function LanguageToggle({ inHeader = false }: LanguageToggleProps) {
  ...
  const baseClasses = "px-3 py-2 text-sm rounded-lg font-medium transition-colors focus:outline-none focus:ring-2 cursor-pointer appearance-none min-h-[40px] flex items-center";
